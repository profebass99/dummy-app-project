...
sudo aws s3 sync s3://rentzone-bucket/nest-app/ /var/www/html
...
sudo sed -i "/^APP_URL=/ s|=.*$|=https://${RECORD_NAME}/|" .env
...
sudo aws s3 cp s3://rentzone-bucket/nest-app/AppServiceProvider.php /var/www/html/app/Providers/AppServiceProvider.php
