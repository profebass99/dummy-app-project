...
resource "aws_eip" "eip_for_nat_gateway_az1" {
  ...
  tags = {
    Name = "${var.environment-prefix}-nat-eip1"
  }
}
...
resource "aws_eip" "eip_for_nat_gateway_az2" {
  ...
  tags = {
    Name = "${var.environment-prefix}-nat-eip2"
  }
}
...
resource "aws_nat_gateway" "nat_gateway_az1" {
  ...
  tags = {
    Name = "${var.environment-prefix}-natgw-AZ1"
  }
...
resource "aws_nat_gateway" "nat_gateway_az2" {
  ...
  tags = {
    Name = "${var.environment-prefix}-natgw-AZ2"
  }
...
resource "aws_route_table" "private_route_table_az1" {
  ...
  tags = {
    Name = "${var.environment-prefix}-private-routetable-AZ1"
  }
}
...
resource "aws_route_table" "private_route_table_az2" {
  ...
  tags = {
    Name = "${var.environment-prefix}-private-routetable-AZ2"
  }
}
